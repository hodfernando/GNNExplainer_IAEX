...
# Referencia https://github.com/pyg-team/pytorch_geometric/blob/master/examples/explain/gnn_explainer_link_pred.py
...
explanation_model = explainer_model(
    x=train_data.x,
...
explanation_phenomenon = explainer_phenomenon(
    x=train_data.x,
    edge_index=train_data.edge_index,
    target=target,
    edge_label_index=edge_label_index,
