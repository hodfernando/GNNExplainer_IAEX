...
# Referencia https://github.com/pyg-team/pytorch_geometric/blob/master/examples/explain/gnn_explainer_ba_shapes.py
...
for explanation_type in ['phenomenon', 'model']:
    ...
    for node_index in tqdm(node_indices, leave=False, desc='Train Explainer'):
        ...
        subset, edge_index, mapping, edge_mask = k_hop_subgraph(node_index, num_hops=3,
                                                 edge_index=data.edge_index)

        targets.append(data.edge_mask[edge_mask].cpu())
